...
void ShaderProgram::setTextureAI(std::string const& textureName, TextureGL &  texture)
{
...
void ShaderProgram::setFloat(std::string const& floatName, float data)
{
    uint32_t intLocation = glGetUniformLocation(programID, floatName.data());
    glUniform1f(intLocation, data);
}
