...
public:
	...
	void setTextureAI(std::string const& textureName, TextureGL &  texture);
	...
	void setInt(std::string const& intName, int data);
	void setFloat(std::string const& floatName, float data);
	int getID();
	~ShaderProgram();
